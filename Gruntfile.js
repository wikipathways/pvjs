var pvjsSources = [
  ...
  'src/js/renderer/svg/svg.js',
  'src/js/renderer/svg/info-box.js',
  'src/js/renderer/svg/symbol.js',
  'src/js/renderer/svg/publication-xref.js',
  'src/js/renderer/svg/node/node.js',
  'src/js/renderer/svg/node/anchor.js',
  'src/js/renderer/svg/node/group-node.js',
  'src/js/renderer/svg/node/use-element.js',
  'src/js/renderer/svg/edge/edge.js',
  'src/js/renderer/svg/marker/marker.js',
  'src/js/renderer/img/img.js',
  'src/js/renderer/svg/path/path.js',
  'src/js/renderer/svg/path/arc.js',
  'src/js/renderer/svg/path/brace.js',
  'src/js/renderer/svg/path/complex.js',
  'src/js/renderer/svg/path/endoplasmic-reticulum.js',
  'src/js/renderer/svg/path/golgi-apparatus.js',
  'src/js/renderer/svg/path/grid-square.js',
  'src/js/renderer/svg/path/hexagon.js',
  'src/js/renderer/svg/path/mim-degradation.js',
  'src/js/renderer/svg/path/line-straight.js',
  'src/js/renderer/svg/path/line-segmented.js',
  'src/js/renderer/svg/path/line-elbow.js',
  'src/js/renderer/svg/path/line-curved.js',
  'src/js/renderer/svg/path/mitochondria.js',
  'src/js/renderer/svg/path/none.js',
  'src/js/renderer/svg/path/oval.js',
  'src/js/renderer/svg/path/oval-double.js',
  'src/js/renderer/svg/path/pentagon.js',
  'src/js/renderer/svg/path/rectangle.js',
  'src/js/renderer/svg/path/rounded-rectangle.js',
  'src/js/renderer/svg/path/rounded-rectangle-double.js',
  'src/js/renderer/svg/path/sarcoplasmic-reticulum.js',
  'src/js/renderer/svg/path/triangle.js',
  'src/js/renderer/svg/text/text.js'
];
