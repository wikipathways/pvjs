var pvjsSources = [
  ...
  'src/js/pathvisiojs/viewer/viewer.js',
  'src/js/pathvisiojs/viewer/annotation/annotation.js',
  'src/js/pathvisiojs/viewer/annotation/citation.js',
  'src/js/pathvisiojs/viewer/annotation/x-ref.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/pathway-diagram.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/svg.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/info-box.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/symbol.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/publication-xref.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/node.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/anchor.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/entity-node.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/path-shape.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/arc.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/brace.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/complex.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/endoplasmic-reticulum.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/golgi-apparatus.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/grid-square.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/hexagon.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/mim-degradation.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/mitochondria.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/none.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/oval.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/oval-double.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/pentagon.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/rectangle.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/rounded-rectangle.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/rounded-rectangle-double.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/sarcoplasmic-reticulum.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/path-shape/triangle.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/node/text.js',
  ...
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/edge/graphical-line.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/edge/interaction.js',
  ...
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/path/line-straight.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/path/line-segmented.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/path/line-elbow.js',
  'src/js/pathvisiojs/viewer/pathway-diagram/svg/path/line-curved.js',
