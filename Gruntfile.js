var pvjsSources = [
  ...
  'src/js/viewer/viewer.js',
  'src/js/viewer/annotation/annotation.js',
  'src/js/viewer/annotation/citation.js',
  'src/js/viewer/annotation/x-ref.js',
  'src/js/viewer/pathway-diagram/pathway-diagram.js',
  'src/js/viewer/pathway-diagram/svg/svg.js',
  'src/js/viewer/pathway-diagram/svg/info-box.js',
  'src/js/viewer/pathway-diagram/svg/symbol.js',
  'src/js/viewer/pathway-diagram/svg/publication-xref.js',
  'src/js/viewer/pathway-diagram/svg/node/node.js',
  'src/js/viewer/pathway-diagram/svg/node/anchor.js',
  'src/js/viewer/pathway-diagram/svg/node/group-node.js',
  'src/js/viewer/pathway-diagram/svg/node/use-element.js',
  'src/js/viewer/pathway-diagram/svg/edge/edge.js',
  'src/js/viewer/pathway-diagram/svg/marker/marker.js',
  'src/js/viewer/pathway-diagram/img/img.js',
  'src/js/viewer/pathway-diagram/svg/path/path.js',
  'src/js/viewer/pathway-diagram/svg/path/arc.js',
  'src/js/viewer/pathway-diagram/svg/path/brace.js',
  'src/js/viewer/pathway-diagram/svg/path/complex.js',
  'src/js/viewer/pathway-diagram/svg/path/endoplasmic-reticulum.js',
  'src/js/viewer/pathway-diagram/svg/path/golgi-apparatus.js',
  'src/js/viewer/pathway-diagram/svg/path/grid-square.js',
  'src/js/viewer/pathway-diagram/svg/path/hexagon.js',
  'src/js/viewer/pathway-diagram/svg/path/mim-degradation.js',
  'src/js/viewer/pathway-diagram/svg/path/line-straight.js',
  'src/js/viewer/pathway-diagram/svg/path/line-segmented.js',
  'src/js/viewer/pathway-diagram/svg/path/line-elbow.js',
  'src/js/viewer/pathway-diagram/svg/path/line-curved.js',
  'src/js/viewer/pathway-diagram/svg/path/mitochondria.js',
  'src/js/viewer/pathway-diagram/svg/path/none.js',
  'src/js/viewer/pathway-diagram/svg/path/oval.js',
  'src/js/viewer/pathway-diagram/svg/path/oval-double.js',
  'src/js/viewer/pathway-diagram/svg/path/pentagon.js',
  'src/js/viewer/pathway-diagram/svg/path/rectangle.js',
  'src/js/viewer/pathway-diagram/svg/path/rounded-rectangle.js',
  'src/js/viewer/pathway-diagram/svg/path/rounded-rectangle-double.js',
  'src/js/viewer/pathway-diagram/svg/path/sarcoplasmic-reticulum.js',
  'src/js/viewer/pathway-diagram/svg/path/triangle.js',
  'src/js/viewer/pathway-diagram/svg/text/text.js'
];
