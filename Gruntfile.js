var pvjsSources = [
  ...
  'src/js/renderer/pathway-diagram/pathway-diagram.js',
  'src/js/renderer/pathway-diagram/svg/svg.js',
  'src/js/renderer/pathway-diagram/svg/info-box.js',
  'src/js/renderer/pathway-diagram/svg/symbol.js',
  'src/js/renderer/pathway-diagram/svg/publication-xref.js',
  'src/js/renderer/pathway-diagram/svg/node/node.js',
  'src/js/renderer/pathway-diagram/svg/node/anchor.js',
  'src/js/renderer/pathway-diagram/svg/node/group-node.js',
  'src/js/renderer/pathway-diagram/svg/node/use-element.js',
  'src/js/renderer/pathway-diagram/svg/edge/edge.js',
  'src/js/renderer/pathway-diagram/svg/marker/marker.js',
  'src/js/renderer/pathway-diagram/img/img.js',
  'src/js/renderer/pathway-diagram/svg/path/path.js',
  'src/js/renderer/pathway-diagram/svg/path/arc.js',
  'src/js/renderer/pathway-diagram/svg/path/brace.js',
  'src/js/renderer/pathway-diagram/svg/path/complex.js',
  'src/js/renderer/pathway-diagram/svg/path/endoplasmic-reticulum.js',
  'src/js/renderer/pathway-diagram/svg/path/golgi-apparatus.js',
  'src/js/renderer/pathway-diagram/svg/path/grid-square.js',
  'src/js/renderer/pathway-diagram/svg/path/hexagon.js',
  'src/js/renderer/pathway-diagram/svg/path/mim-degradation.js',
  'src/js/renderer/pathway-diagram/svg/path/line-straight.js',
  'src/js/renderer/pathway-diagram/svg/path/line-segmented.js',
  'src/js/renderer/pathway-diagram/svg/path/line-elbow.js',
  'src/js/renderer/pathway-diagram/svg/path/line-curved.js',
  'src/js/renderer/pathway-diagram/svg/path/mitochondria.js',
  'src/js/renderer/pathway-diagram/svg/path/none.js',
  'src/js/renderer/pathway-diagram/svg/path/oval.js',
  'src/js/renderer/pathway-diagram/svg/path/oval-double.js',
  'src/js/renderer/pathway-diagram/svg/path/pentagon.js',
  'src/js/renderer/pathway-diagram/svg/path/rectangle.js',
  'src/js/renderer/pathway-diagram/svg/path/rounded-rectangle.js',
  'src/js/renderer/pathway-diagram/svg/path/rounded-rectangle-double.js',
  'src/js/renderer/pathway-diagram/svg/path/sarcoplasmic-reticulum.js',
  'src/js/renderer/pathway-diagram/svg/path/triangle.js',
  'src/js/renderer/pathway-diagram/svg/text/text.js'
];
