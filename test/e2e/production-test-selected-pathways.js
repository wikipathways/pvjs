...
ptor.get(baseUri + "test/production.html?gpml=WP2545").
  then(function() {
  ...
  then(function() {
    ...
    ptor.get(baseUri + "test/production.html?gpml=WP2605");
    return ptor.wait(forElementToBePresent(by.css('#pathvisiojs-is-loaded')), 30 * 1000);
  }).
  then(function() {
  ...
  then(function() {
    ...
    ptor.get(baseUri + "test/production.html?gpml=WP2554");
    return ptor.wait(forElementToBePresent(by.css('#pathvisiojs-is-loaded')), 30 * 1000);
  }).
  /*
  then(function() {
  ...
  then(function() {
    ...
    ptor.get(baseUri + "test/production.html?gpml=WP2557");
    return ptor.wait(forElementToBePresent(by.css('#pathvisiojs-is-loaded')), 30 * 1000);
  }).
/*
  then(function() {
  ...
  then(function() {
    ...
    ptor.get(baseUri + "test/production.html?gpml=WP2546");
  }).
  then(function() {
    return ptor.wait(forElementToBePresent(by.css('#pathvisiojs-is-loaded')), 30 * 1000);
  }).
  ...
  then(function() {
    ...
    ptor.get(baseUri + "test/production.html?gpml=WP2548");
  }).
  then(function() {
    return ptor.wait(forElementToBePresent(by.css('#pathvisiojs-is-loaded')), 30 * 1000);
  }).
  ...
  then(function() {
    ...
    ptor.get(baseUri + "test/production.html?gpml=WP2551");
    return ptor.wait(forElementToBePresent(by.css('#pathvisiojs-is-loaded')), 30 * 1000);
  }).
  then(function() {
    return ptor.sleep(5 * 1000);
  ...
  then(function() {
    ...
    ptor.get(baseUri + "test/production.html?gpml=WP1");
    return ptor.wait(forElementToBePresent(by.css('#pathvisiojs-is-loaded')), 30 * 1000);
  }).
