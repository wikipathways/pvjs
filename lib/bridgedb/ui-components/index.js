...
function BridgeDbUIElement(args) {
  ...
  var latestEntityFiltered$ = latestEntity$
    .filter(function(entity) {
    return _.isObject(entity);
  });

  entityIn$
  .filter(function(entity) {
    var entityKeys = _.keys(entity);
    return entityKeys && entityKeys.length;
  })
  .concatMap(function(entity) {
  ...
  return h('nav', {
        ...
        h('div', {
            ...
            h(EntityReferenceSearch, {
              organism: latestEntityFiltered$.map(function(entity) {
              ...
              onChange: function(entityReference) {
                ...
                // of the entity type
                latestEntityFiltered$
                .first()
                .subscribe(function(latestEntityFiltered) {
                  var updatedEntity = {};
                  ...
                  updatedEntity = transferSpecifiedProperties(
                      specifiedEntityKeys, latestEntityFiltered, updatedEntity
                  );
                  ...
                  err.message = err.message || '';
                  err.message += ', observed in latestEntityFiltered$ (E.R. Search onChange)';
                  throw err;
                });
              },
            })
        ...
        h('div', {
            ...
            h(EntityTypeControl, {
              entityType: latestEntityFiltered$.map(function(entity) {
                return entity.type;
              }),
              onChange: function(entityType) {
                ...
                .subscribe(function(entity) {
                  ...
                  err.message = err.message || '';
                  err.message += ', observed in latestEntityFiltered$ (EntityTypeCtrl onChange)';
                  throw err;
                });
              },
            }),
            h(DatasourceControl, {
              datasource: latestEntityFiltered$.map(function(entity) {
                return entity.entityReference.isDataItemIn;
              }),
              entityType: latestEntityFiltered$
              .map(function(entity) {
                return entity.type;
              }),
              onChange: function(datasource) {
                ...
                .subscribe(function(latestEntityFiltered) {
                  ...
                  updatedEntity.entityReference = transferSpecifiedProperties(
                      specifiedEntityReferenceKeys, latestEntityFiltered.entityReference
                  );
                  ...
                  err.message = err.message || '';
                  err.message += ', observed in latestEntityFiltered$ (DatasourceCtrl onChange)';
                  throw err;
                });
              },
            }),
            h(IdentifierControl, {
              identifier: latestEntityFiltered$
                          .map(function(entity) {
              ...
              onChange: function(identifier) {
                ...
                .subscribe(function(latestEntityFiltered) {
                  ...
                  err.message = err.message || '';
                  err.message += ', observed in latestEntityFiltered$ (IdentifierCtrl onChange)';
                  throw err;
                });
              },
            }),
            h('input', {
              ...
              onChange: function(ev) {
                ...
                .first()
                .subscribe(function(latestEntityFiltered) {
                  latestEntityFiltered.displayName = updatedDisplayName;
                  entityOut$.onNext(latestEntityFiltered);
                }, function(err) {
                  err.message = err.message || '';
                  err.message += ', observed in latestEntityFiltered$ (DisplayNameCtrl onChange)';
                  throw err;
                });
              },
              //required: required$,
              type: 'text',
              value: latestEntityFiltered$
                     .map(function(entity) {
