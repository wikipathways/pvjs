...
var BridgeDbMithrilComponent = {
  ...
  /**
   BridgeDbMithrilComponent config factory. The params in this doc refer to properties of the `ctrl` argument
   @param {Object} entity - the entity to be processed by BridgeDb
   */
