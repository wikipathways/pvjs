...
pathvisio.pathway.labelableElement = function(){ 
  function drawAll() {
    var labelableElementsContainer = pathvisio.current.svg.selectAll("g.labelable-elements-container")	
    .data(pathvisio.pathways[pathvisio.current.svgSelector].labelableElements)
    .enter()
    .append("g")
    ...
    var labelableElements = labelableElementsContainer.each(function(d) {
      ...
      .attr("class", function (d) { 
        ...
        if (symbolsAvailable.filter(function(d, i) { return (symbolsAvailable[0][i].id === pathvisio.pathways[pathvisio.current.svgSelector].labelableElements[0].symbolType); }).length > 0) {
          ...
          console.log('Pathvisio.js does not have access to the requested symbol: ' + pathvisio.pathways[pathvisio.current.svgSelector].labelableElements[0].symbolType + '. Rectangle used as placeholder.');
        };
