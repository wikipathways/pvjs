...
symbols.each(function(d, i) {
  symbolDouble = pathvisiojs.utilities.cloneNode(this);
  ...
  symbolElementsContainerDouble = pathvisiojs.utilities.cloneNode(symbolElementsContainerOriginal[0][0]);
...
var doubleOriginal = doubleOriginals[0][0];
          ...
          var doubleOverlay = pathvisiojs.utilities.cloneNode(doubleOriginal);
...
symbols.each(function(d, i) {
  doubleSymbol = pathvisiojs.utilities.cloneNode(this);
  ...
  var doubleContainer = pathvisiojs.utilities.cloneNode(container);
...
symbols.each(function(d, i) {
  ...
  var container = moveElementsIntoContainer(doubleSymbol);
  doubleSymbol[0][0].appendChild(container[0][0]);
  var doubleContainer = pathvisiojs.utilities.cloneNode(container[0][0]);
  doubleContainer[0][0].setAttribute('id', 'container-double' );
