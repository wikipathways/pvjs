                    ...
                    if (!!dataElement.datasourceReference) {
                      ...
                      .on("mouseup", function(d,i) {
                        if (notDragged) {
                          ...
                          pathvisiojs.view.annotation.xRef.render(dfOrganism, dfId, dfDatabase, dataElement.textContent, dataElement.dataNodeType);
                        }
                      });
                    }
                  });
        ...
        if (!!data) {
          ...
          if (elementsWithPublicationXrefs.length > 0) {
            elementsWithPublicationXrefs.forEach(function(elementWithPublicationXrefs) {
              pathvisiojs.view.pathwayDiagram.svg.publicationXref.render(viewport, elementWithPublicationXrefs);
            });
          }
        }
        callbackInside(null);
