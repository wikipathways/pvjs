...
*/
		function stylePathwayImage(pathwayImage) {
			pathwayImage[0].setAttribute("style", "width: 100%; height: 100%; background-color: #ffffff; bottom:0; top:0; left:0; right:0; margin-top:0; margin-bottom:0; margin-right:0; margin-left:0;");
...
<<<<<<< HEAD
					createNodeShape(elm[0])
=======
>>>>>>> 42066961e7964b30d31e9281fdbf93b58cbd3467
					var doc = document.getElementById('pathwayObjectFlash').contentDocument;                
					var g = document.createElementNS(svgns, 'g');
					createNodeShape(g)
					var root = doc.getElementById('node' + $scope.DataNode["@GraphId"]); // Got it
