...
export let markerDrawers: any = {
    ...
    'mim-inhibition': (backgroundColor, Color) => {
        return markerDrawers.TBar(backgroundColor, Color);
    },
    'mim-conversion': (backgroundColor, Color) => {
        return markerDrawers.Arrow(backgroundColor, Color)
    },
    ...
    'mim-branching-left': (backgroundColor, Color) => {
        return markerDrawers.Arrow(backgroundColor, Color)
    },
    'mim-branching-right': (backgroundColor, Color) => {
        return markerDrawers.Arrow(backgroundColor, Color)
    }
};