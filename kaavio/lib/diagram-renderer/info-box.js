...
module.exports = {
  render: function(viewport, data) {
    ...
    // Although gpml has x and y values for infobox, we have decided to ignore them
    // and always set it in the upper left.
    ...
    if (data.hasOwnProperty('PublicationXref')) {
      kaavio.renderer.publicationXref.getPublicationXrefString(
          data, data.PublicationXref, function(publicationXrefString) {
